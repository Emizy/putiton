...
urlpatterns = [
                  ...
                  url(r'^a_makeup/(?P<art_id>[0-9]+)/$', views.a_makeup, name='a_makeup'),
                  url(r'^d_stylist/(?P<sty_id>[0-9]+)/$', views.d_stylist, name='d_stylist'),
                  # url(r'^store/(?P<user_id>[0-9]+)/$', views.store, name='store'),
                  ...
                  url(r'^makeup_artist/', views.makeup_artist, name="makeup_artist"),
                  url(r'^stylist/', views.stylist, name="stylist"),
